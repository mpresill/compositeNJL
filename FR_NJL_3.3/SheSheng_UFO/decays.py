...
Decay_mu__minus__ = Decay(name = 'Decay_mu__minus__',
                          ...
                          partial_widths = {(P.Pi0d,P.Muc):'((-(MassB**2*Ystar**2) + MassF**2*Ystar**2 + MM**2*Ystar**2)*cmath.sqrt(MassB**4 - 2*MassB**2*MassF**2 + MassF**4 - 2*MassB**2*MM**2 - 2*MassF**2*MM**2 + MM**4))/(32.*cmath.pi*abs(MM)**3)',
                                            (P.Pi53due__tilde__,P.c):'((-MassB**2 + MM**2)*(-3*MassB**2*Ystar**2 + 3*MM**2*Ystar**2))/(32.*cmath.pi*abs(MM)**3)',
                                            ...
                                            (P.Pid23due__tilde__,P.s):'((-MassB**2 + MM**2)*(-3*MassB**2*Ystar**2 + 3*MM**2*Ystar**2))/(32.*cmath.pi*abs(MM)**3)',
...
Decay_Pi0d = Decay(name = 'Decay_Pi0d',
                   ...
                   partial_widths = {(P.a,P.a):'(aEW**2*MassB**6*Ustar**2)/(144.*cmath.pi**3*abs(MassB)**3)',
                                     ...
                                     (P.b,P.b__tilde__):'(3*MassB**4*Ystar**2)/(8.*cmath.pi*abs(MassB)**3)',
...
Decay_Pi13due = Decay(name = 'Decay_Pi13due',
                      particle = P.Pi13due,
                      partial_widths = {(P.s,P.vm__tilde__):'(MassB**4*Ystar**2)/(16.*cmath.pi*abs(MassB)**3)'})

Decay_Pi13tre = Decay(name = 'Decay_Pi13tre',
                      particle = P.Pi13tre,
                      partial_widths = {(P.b,P.vt__tilde__):'(MassB**4*Ystar**2)/(16.*cmath.pi*abs(MassB)**3)'})

Decay_Pi13uno = Decay(name = 'Decay_Pi13uno',
                      particle = P.Pi13uno,
                      partial_widths = {(P.d,P.ve__tilde__):'(MassB**4*Ystar**2)/(16.*cmath.pi*abs(MassB)**3)'})
...
Decay_Pi53tre = Decay(name = 'Decay_Pi53tre',
                      particle = P.Pi53tre,
                      partial_widths = {(P.t,P.ta__plus__):'((3*MassB**2*Ystar**2 - 3*MT**2*Ystar**2 - 3*MTA**2*Ystar**2)*cmath.sqrt(MassB**4 - 2*MassB**2*MT**2 + MT**4 - 2*MassB**2*MTA**2 - 2*MT**2*MTA**2 + MTA**4))/(48.*cmath.pi*abs(MassB)**3)'})

Decay_Pi53uno = Decay(name = 'Decay_Pi53uno',
                      particle = P.Pi53uno,
                      partial_widths = {(P.u,P.e__plus__):'(MassB**4*Ystar**2)/(16.*cmath.pi*abs(MassB)**3)'})
...
Decay_Pic1__plus__ = Decay(name = 'Decay_Pic1__plus__',
                           ...
                           partial_widths = {(P.a,P.W__plus__):'((MassB**2 - MW**2)*((9*aEW**2*MassB**4*Ustar**2)/(16.*cmath.pi**2*sw**2) - (9*aEW**2*MassB**2*MW**2*Ustar**2)/(8.*cmath.pi**2*sw**2) + (9*aEW**2*MW**4*Ustar**2)/(16.*cmath.pi**2*sw**2)))/(16.*cmath.pi*abs(MassB)**3)',
                                             ...
                                             (P.t,P.b__tilde__):'((MassB**2 - MT**2)*(3*MassB**2*Ystar**2 - 3*MT**2*Ystar**2))/(16.*cmath.pi*abs(MassB)**3)',
...
Decay_Pid23due = Decay(name = 'Decay_Pid23due',
                       particle = P.Pid23due,
                       partial_widths = {(P.s,P.mu__plus__):'((MassB**2 - MM**2)*(3*MassB**2*Ystar**2 - 3*MM**2*Ystar**2))/(48.*cmath.pi*abs(MassB)**3)'})

Decay_Pid23tre = Decay(name = 'Decay_Pid23tre',
                       particle = P.Pid23tre,
                       partial_widths = {(P.b,P.ta__plus__):'((MassB**2 - MTA**2)*(3*MassB**2*Ystar**2 - 3*MTA**2*Ystar**2))/(48.*cmath.pi*abs(MassB)**3)'})

Decay_Pid23uno = Decay(name = 'Decay_Pid23uno',
                       particle = P.Pid23uno,
                       partial_widths = {(P.d,P.e__plus__):'(MassB**4*Ystar**2)/(16.*cmath.pi*abs(MassB)**3)'})
...
Decay_Piu23tre = Decay(name = 'Decay_Piu23tre',
                       particle = P.Piu23tre,
                       partial_widths = {(P.t,P.vt__tilde__):'((MassB**2 - MT**2)*(3*MassB**2*Ystar**2 - 3*MT**2*Ystar**2))/(48.*cmath.pi*abs(MassB)**3)'})

Decay_Piu23uno = Decay(name = 'Decay_Piu23uno',
                       particle = P.Piu23uno,
                       partial_widths = {(P.u,P.ve__tilde__):'(MassB**4*Ystar**2)/(16.*cmath.pi*abs(MassB)**3)'})

Decay_t = Decay(name = 'Decay_t',
                particle = P.t,
                partial_widths = {(P.Pi53tre,P.ta__minus__):'((-3*MassB**2*Ystar**2 + 3*MT**2*Ystar**2 + 3*MTA**2*Ystar**2)*cmath.sqrt(MassB**4 - 2*MassB**2*MT**2 + MT**4 - 2*MassB**2*MTA**2 - 2*MT**2*MTA**2 + MTA**4))/(96.*cmath.pi*abs(MT)**3)',
                                  (P.Pic1__plus__,P.b):'((-MassB**2 + MT**2)*(-3*MassB**2*Ystar**2 + 3*MT**2*Ystar**2))/(96.*cmath.pi*abs(MT)**3)',
                                  (P.Piu23tre,P.vt):'((-MassB**2 + MT**2)*(-3*MassB**2*Ystar**2 + 3*MT**2*Ystar**2))/(96.*cmath.pi*abs(MT)**3)',
...
Decay_ta__minus__ = Decay(name = 'Decay_ta__minus__',
                          ...
                          partial_widths = {(P.Pi0d,P.Tauc):'((-(MassB**2*Ystar**2) + MassF**2*Ystar**2 + MTA**2*Ystar**2)*cmath.sqrt(MassB**4 - 2*MassB**2*MassF**2 + MassF**4 - 2*MassB**2*MTA**2 - 2*MassF**2*MTA**2 + MTA**4))/(32.*cmath.pi*abs(MTA)**3)',
                                            (P.Pi53tre__tilde__,P.t):'((-3*MassB**2*Ystar**2 + 3*MT**2*Ystar**2 + 3*MTA**2*Ystar**2)*cmath.sqrt(MassB**4 - 2*MassB**2*MT**2 + MT**4 - 2*MassB**2*MTA**2 - 2*MT**2*MTA**2 + MTA**4))/(32.*cmath.pi*abs(MTA)**3)',
                                            ...
                                            (P.Pid23tre__tilde__,P.b):'((-MassB**2 + MTA**2)*(-3*MassB**2*Ystar**2 + 3*MTA**2*Ystar**2))/(32.*cmath.pi*abs(MTA)**3)',
