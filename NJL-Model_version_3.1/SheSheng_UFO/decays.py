...
Decay_E0 = Decay(name = 'Decay_E0',
                 particle = P.E0,
                 partial_widths = {(P.Pic1__plus__,P.e__minus__):'((-MassB**2 + MassF**2)*(-(MassB**2*Ystar**4) + MassF**2*Ystar**4))/(32.*cmath.pi*abs(MassF)**3)'})

Decay_Ec = Decay(name = 'Decay_Ec',
                 particle = P.Ec,
                 partial_widths = {(P.Pi0d,P.e__minus__):'((-MassB**2 + MassF**2)*(-(MassB**2*Ystar**4) + MassF**2*Ystar**4))/(32.*cmath.pi*abs(MassF)**3)'})
...
Decay_N01 = Decay(name = 'Decay_N01',
                  particle = P.N01,
                  partial_widths = {(P.Pi0u,P.ve):'((-MassB**2 + MassF**2)*(-(MassB**2*Ystar**4) + MassF**2*Ystar**4))/(32.*cmath.pi*abs(MassF)**3)'})

Decay_Nc1 = Decay(name = 'Decay_Nc1',
                  particle = P.Nc1,
                  partial_widths = {(P.Pic1__tilde__,P.ve):'((-MassB**2 + MassF**2)*(-(MassB**2*Ystar**4) + MassF**2*Ystar**4))/(32.*cmath.pi*abs(MassF)**3)'})

Decay_Pi0d = Decay(name = 'Decay_Pi0d',
                   particle = P.Pi0d,
                   partial_widths = {(P.a,P.a):'(aEW**2*MassB**6*Ustar**2)/(576.*cmath.pi**3*abs(MassB)**3)',
                                     (P.a,P.Z):'((MassB**2 - MZ**2)*(-0.010416666666666666*(aEW**2*MassB**4*Ustar**2)/(cw**2*cmath.pi**2) + (aEW**2*MassB**2*MZ**2*Ustar**2)/(48.*cw**2*cmath.pi**2) - (aEW**2*MZ**4*Ustar**2)/(96.*cw**2*cmath.pi**2) + (aEW**2*MassB**4*Ustar**2)/(128.*cw**2*cmath.pi**2*sw**2) - (aEW**2*MassB**2*MZ**2*Ustar**2)/(64.*cw**2*cmath.pi**2*sw**2) + (aEW**2*MZ**4*Ustar**2)/(128.*cw**2*cmath.pi**2*sw**2) + (aEW**2*MassB**4*sw**2*Ustar**2)/(288.*cw**2*cmath.pi**2) - (aEW**2*MassB**2*MZ**2*sw**2*Ustar**2)/(144.*cw**2*cmath.pi**2) + (aEW**2*MZ**4*sw**2*Ustar**2)/(288.*cw**2*cmath.pi**2)))/(16.*cmath.pi*abs(MassB)**3)',
                                     (P.d,P.d__tilde__):'(3*MassB**4*Ystar**4)/(8.*cmath.pi*abs(MassB)**3)',
                                     (P.e__minus__,P.Ec__tilde__):'((MassB**2 - MassF**2)*(MassB**2*Ystar**4 - MassF**2*Ystar**4))/(16.*cmath.pi*abs(MassB)**3)',
                                     (P.Ec,P.e__plus__):'((MassB**2 - MassF**2)*(MassB**2*Ystar**4 - MassF**2*Ystar**4))/(16.*cmath.pi*abs(MassB)**3)',
                                     (P.W__minus__,P.W__plus__):'(((9*aEW**2*MassB**4*Ustar**2)/(512.*cmath.pi**2*sw**4) - (9*aEW**2*MassB**2*MW**2*Ustar**2)/(128.*cmath.pi**2*sw**4))*cmath.sqrt(MassB**4 - 4*MassB**2*MW**2))/(16.*cmath.pi*abs(MassB)**3)',
                                     (P.Z,P.Z):'(((aEW**2*MassB**4*Ustar**2)/(32.*cw**4*cmath.pi**2) - (aEW**2*MassB**2*MZ**2*Ustar**2)/(8.*cw**4*cmath.pi**2) + (9*aEW**2*MassB**4*Ustar**2)/(128.*cw**4*cmath.pi**2*sw**4) - (9*aEW**2*MassB**2*MZ**2*Ustar**2)/(32.*cw**4*cmath.pi**2*sw**4) - (3*aEW**2*MassB**4*Ustar**2)/(32.*cw**4*cmath.pi**2*sw**2) + (3*aEW**2*MassB**2*MZ**2*Ustar**2)/(8.*cw**4*cmath.pi**2*sw**2))*cmath.sqrt(MassB**4 - 4*MassB**2*MZ**2))/(32.*cmath.pi*abs(MassB)**3)'})

Decay_Pi0u = Decay(name = 'Decay_Pi0u',
                   particle = P.Pi0u,
                   partial_widths = {(P.a,P.a):'(aEW**2*MassB**6*Ustar**2)/(36.*cmath.pi**3*abs(MassB)**3)',
                                     (P.a,P.Z):'((MassB**2 - MZ**2)*(-0.08333333333333333*(aEW**2*MassB**4*Ustar**2)/(cw**2*cmath.pi**2) + (aEW**2*MassB**2*MZ**2*Ustar**2)/(6.*cw**2*cmath.pi**2) - (aEW**2*MZ**4*Ustar**2)/(12.*cw**2*cmath.pi**2) + (aEW**2*MassB**4*Ustar**2)/(32.*cw**2*cmath.pi**2*sw**2) - (aEW**2*MassB**2*MZ**2*Ustar**2)/(16.*cw**2*cmath.pi**2*sw**2) + (aEW**2*MZ**4*Ustar**2)/(32.*cw**2*cmath.pi**2*sw**2) + (aEW**2*MassB**4*sw**2*Ustar**2)/(18.*cw**2*cmath.pi**2) - (aEW**2*MassB**2*MZ**2*sw**2*Ustar**2)/(9.*cw**2*cmath.pi**2) + (aEW**2*MZ**4*sw**2*Ustar**2)/(18.*cw**2*cmath.pi**2)))/(16.*cmath.pi*abs(MassB)**3)',
                                     (P.N01,P.ve__tilde__):'((MassB**2 - MassF**2)*(MassB**2*Ystar**4 - MassF**2*Ystar**4))/(16.*cmath.pi*abs(MassB)**3)',
                                     (P.u,P.u__tilde__):'(3*MassB**4*Ystar**4)/(8.*cmath.pi*abs(MassB)**3)',
                                     (P.ve,P.N01__tilde__):'((MassB**2 - MassF**2)*(MassB**2*Ystar**4 - MassF**2*Ystar**4))/(16.*cmath.pi*abs(MassB)**3)',
                                     (P.W__minus__,P.W__plus__):'(((9*aEW**2*MassB**4*Ustar**2)/(512.*cmath.pi**2*sw**4) - (9*aEW**2*MassB**2*MW**2*Ustar**2)/(128.*cmath.pi**2*sw**4))*cmath.sqrt(MassB**4 - 4*MassB**2*MW**2))/(16.*cmath.pi*abs(MassB)**3)',
                                     (P.Z,P.Z):'(((aEW**2*MassB**4*Ustar**2)/(8.*cw**4*cmath.pi**2) - (aEW**2*MassB**2*MZ**2*Ustar**2)/(2.*cw**4*cmath.pi**2) + (9*aEW**2*MassB**4*Ustar**2)/(128.*cw**4*cmath.pi**2*sw**4) - (9*aEW**2*MassB**2*MZ**2*Ustar**2)/(32.*cw**4*cmath.pi**2*sw**4) - (3*aEW**2*MassB**4*Ustar**2)/(16.*cw**4*cmath.pi**2*sw**2) + (3*aEW**2*MassB**2*MZ**2*Ustar**2)/(4.*cw**4*cmath.pi**2*sw**2))*cmath.sqrt(MassB**4 - 4*MassB**2*MZ**2))/(32.*cmath.pi*abs(MassB)**3)'})

Decay_Pi13 = Decay(name = 'Decay_Pi13',
                   particle = P.Pi13,
                   partial_widths = {(P.d,P.ve__tilde__):'(MassB**4*Ystar**4)/(16.*cmath.pi*abs(MassB)**3)'})

Decay_Pi53 = Decay(name = 'Decay_Pi53',
                   particle = P.Pi53,
                   partial_widths = {(P.u,P.e__plus__):'(MassB**4*Ystar**4)/(16.*cmath.pi*abs(MassB)**3)'})
...
Decay_Pic1__plus__ = Decay(name = 'Decay_Pic1__plus__',
                           ...
                           partial_widths = {(P.a,P.W__plus__):'((MassB**2 - MW**2)*((9*aEW**2*MassB**4*Ustar**2)/(16.*cmath.pi**2*sw**2) - (9*aEW**2*MassB**2*MW**2*Ustar**2)/(8.*cmath.pi**2*sw**2) + (9*aEW**2*MW**4*Ustar**2)/(16.*cmath.pi**2*sw**2)))/(16.*cmath.pi*abs(MassB)**3)',
                                             (P.E0,P.e__plus__):'((MassB**2 - MassF**2)*(MassB**2*Ystar**4 - MassF**2*Ystar**4))/(16.*cmath.pi*abs(MassB)**3)',
                                             (P.u,P.d__tilde__):'(3*MassB**4*Ystar**4)/(16.*cmath.pi*abs(MassB)**3)',
                                             (P.ve,P.Nc1__tilde__):'((MassB**2 - MassF**2)*(MassB**2*Ystar**4 - MassF**2*Ystar**4))/(16.*cmath.pi*abs(MassB)**3)',
...
Decay_Pid23 = Decay(name = 'Decay_Pid23',
                    particle = P.Pid23,
                    partial_widths = {(P.d,P.e__plus__):'(MassB**4*Ystar**4)/(16.*cmath.pi*abs(MassB)**3)'})

Decay_Piu23 = Decay(name = 'Decay_Piu23',
                    particle = P.Piu23,
                    partial_widths = {(P.u,P.ve__tilde__):'(MassB**4*Ystar**4)/(16.*cmath.pi*abs(MassB)**3)'})
...
Decay_Z = Decay(name = 'Decay_Z',
                particle = P.Z,
                partial_widths = {(P.a,P.Pi0d):'((-MassB**2 + MZ**2)*(-0.010416666666666666*(aEW**2*MassB**4*Ustar**2)/(cw**2*cmath.pi**2) + (aEW**2*MassB**2*MZ**2*Ustar**2)/(48.*cw**2*cmath.pi**2) - (aEW**2*MZ**4*Ustar**2)/(96.*cw**2*cmath.pi**2) + (aEW**2*MassB**4*Ustar**2)/(128.*cw**2*cmath.pi**2*sw**2) - (aEW**2*MassB**2*MZ**2*Ustar**2)/(64.*cw**2*cmath.pi**2*sw**2) + (aEW**2*MZ**4*Ustar**2)/(128.*cw**2*cmath.pi**2*sw**2) + (aEW**2*MassB**4*sw**2*Ustar**2)/(288.*cw**2*cmath.pi**2) - (aEW**2*MassB**2*MZ**2*sw**2*Ustar**2)/(144.*cw**2*cmath.pi**2) + (aEW**2*MZ**4*sw**2*Ustar**2)/(288.*cw**2*cmath.pi**2)))/(48.*cmath.pi*abs(MZ)**3)',
                                  (P.a,P.Pi0u):'((-MassB**2 + MZ**2)*(-0.08333333333333333*(aEW**2*MassB**4*Ustar**2)/(cw**2*cmath.pi**2) + (aEW**2*MassB**2*MZ**2*Ustar**2)/(6.*cw**2*cmath.pi**2) - (aEW**2*MZ**4*Ustar**2)/(12.*cw**2*cmath.pi**2) + (aEW**2*MassB**4*Ustar**2)/(32.*cw**2*cmath.pi**2*sw**2) - (aEW**2*MassB**2*MZ**2*Ustar**2)/(16.*cw**2*cmath.pi**2*sw**2) + (aEW**2*MZ**4*Ustar**2)/(32.*cw**2*cmath.pi**2*sw**2) + (aEW**2*MassB**4*sw**2*Ustar**2)/(18.*cw**2*cmath.pi**2) - (aEW**2*MassB**2*MZ**2*sw**2*Ustar**2)/(9.*cw**2*cmath.pi**2) + (aEW**2*MZ**4*sw**2*Ustar**2)/(18.*cw**2*cmath.pi**2)))/(48.*cmath.pi*abs(MZ)**3)',
