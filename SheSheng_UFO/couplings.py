...
GC_10 = Coupling(name = 'GC_10',
                 value = '(complex(0,1)*gstar)/cmath.sqrt(2)',
                 order = {'NP':1})
...
GC_18 = Coupling(name = 'GC_18',
                 value = '(3*ee**2*complex(0,1))/(4.*FPi*cmath.pi*sw**2)',
                 order = {'QED':2})
...
GC_33 = Coupling(name = 'GC_33',
                 value = '(-3*cw*ee**2*complex(0,1))/(FPi*cmath.pi*sw) + (3*ee**2*complex(0,1)*sw)/(cw*FPi*cmath.pi)',
                 order = {'QED':2})
...
GC_35 = Coupling(name = 'GC_35',
                 value = '(-3*ee**2*complex(0,1))/(FPi*cmath.pi) + (3*cw**2*ee**2*complex(0,1))/(2.*FPi*cmath.pi*sw**2) + (3*ee**2*complex(0,1)*sw**2)/(2.*cw**2*FPi*cmath.pi)',
                 order = {'QED':2})
